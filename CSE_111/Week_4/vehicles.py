def main():
    ...
    # Check if the vin is a key that is in the5TDZA23CXTU1029835TDZA23CXTU102983 vehicles dictionary.
    if vin in vehicles_dict:
        ...
        print(f"{'Manufacturer:':>14}{vehicle[MANUFACTURER_INDEX]:<8}")
        print(f"{'Model:':>14}{vehicle[MODEL_INDEX]:<8}")
        print(f"{'Color:':>14}{vehicle[COLOR_INDEX]:<8}")
